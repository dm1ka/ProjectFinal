document.addEventListener("DOMContentLoaded", function () { const form = document.querySelector("form"); const text = document.getElementById("text"); const file = document.getElementById("file"); const keyInput = document.getElementById("key"); const keyStrength = document.getElementById("keyStrength");
